"".add_a_and_b STEXT nosplit size=19 args=0x18 locals=0x0
	0x0000 00000 (asm.go:3)	TEXT	"".add_a_and_b(SB), NOSPLIT, $0-24
	0x0000 00000 (asm.go:3)	FUNCDATA	$0, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (asm.go:3)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (asm.go:3)	FUNCDATA	$3, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (asm.go:4)	PCDATA	$2, $0
	0x0000 00000 (asm.go:4)	PCDATA	$0, $0
	0x0000 00000 (asm.go:4)	MOVQ	"".b+16(SP), AX
	0x0005 00005 (asm.go:4)	MOVQ	"".a+8(SP), CX
	0x000a 00010 (asm.go:4)	ADDQ	CX, AX
	0x000d 00013 (asm.go:4)	MOVQ	AX, "".~r2+24(SP)
	0x0012 00018 (asm.go:4)	RET
	0x0000 48 8b 44 24 10 48 8b 4c 24 08 48 01 c8 48 89 44  H.D$.H.L$.H..H.D
	0x0010 24 18 c3                                         $..
"".main STEXT nosplit size=1 args=0x0 locals=0x0
	0x0000 00000 (asm.go:7)	TEXT	"".main(SB), NOSPLIT, $0-0
	0x0000 00000 (asm.go:7)	FUNCDATA	$0, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (asm.go:7)	FUNCDATA	$1, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
	0x0000 00000 (asm.go:7)	FUNCDATA	$3, gclocals·33cdeccccebe80329f1fdbee7f5874cb(SB)
...
go.info."".add_a_and_b$abstract SDWARFINFO dupok size=33
	0x0000 03 2e 61 64 64 5f 61 5f 61 6e 64 5f 62 00 01 01  ..add_a_and_b...
	0x0010 10 61 00 00 00 00 00 00 10 62 00 00 00 00 00 00  .a.......b......
	0x0020 00                                               .
	rel 20+4 t=28 go.info.int+0
	rel 28+4 t=28 go.info.int+0
go.loc."".add_a_and_b SDWARFLOC size=0
go.info."".add_a_and_b SDWARFINFO size=48
	0x0000 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
	0x0010 00 00 00 00 00 01 9c 11 00 00 00 00 00 11 00 00  ................
	0x0020 00 00 00 0e 7e 72 32 00 01 03 00 00 00 00 00 00  ....~r2.........
	rel 1+4 t=28 go.info."".add_a_and_b$abstract+0
	rel 5+8 t=1 "".add_a_and_b+0
	rel 13+8 t=1 "".add_a_and_b+19
	rel 24+4 t=28 go.info."".add_a_and_b$abstract+16
	rel 30+4 t=28 go.info."".add_a_and_b$abstract+24
	rel 42+4 t=28 go.info.int+0
go.range."".add_a_and_b SDWARFRANGE size=0
go.isstmt."".add_a_and_b SDWARFMISC size=0
...
go.info."".main SDWARFINFO size=33
	...
	rel 9+8 t=1 "".main+0
	rel 17+8 t=1 "".main+1
	rel 27+4 t=29 gofile../Users/michael/Documents/working/go/src/go_test/asm_go/asm.go+0
